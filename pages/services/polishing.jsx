		...
		<>
			...
			<Price
				...
				list={[
					{
						thumb: '',
						label: 'Керамика', // Керамика (от 2х слоев) // Доп. Слой керамики (3..) 6тыс руб
						value: 12000,
					},
					{
						thumb: '',
						label: 'Жидкое стекло', // Жидкое стекло (1 слой)
						value: 6000,
					},
					{
						thumb: '',
						label: 'Воск', // Воск (быстрое стекло)
						value: 3000,
					},
					{
						thumb: '',
						label: 'Косметическая', // Косметическая Полировка
						value: 6000,
					},
					{
						thumb: '',
						label: 'Детейлинг', // Дитейлинг полировка
						value: 10000,
					},
					{
						thumb: '',
					...
					{
						thumb: '',
						label: 'Комплекс 1', // Дитейлинг Комплекс 1: полировка+жидкое стекло (+передняя полусфера "антидождь")
						value: 16000,
					},
					{
						thumb: '',
